...
```
#### Note
Because of the large table of abbreviations, the conversion from the jflex source to java, i.e. the calculation of the DFA,
takes 4 to 20 minutes, depending on your hardware, and requires a lot of heap space.
